...
class _TvWidgetState extends State<TvWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          ...
          _model.textController15?.text = FFLocalizations.of(context).getText(
            '6ucnc02t' /* 0.044 */,
          );
          _model.textController16?.text = FFLocalizations.of(context).getText(
            'yt8h50fd' /* 10 */,
          );
          _model.textController17?.text = FFLocalizations.of(context).getText(
            'lfmjxyzz' /* 28.7 */,
          );
          _model.textController18?.text = FFLocalizations.of(context).getText(
            'xb9gdosy' /* 5.76 */,
          );
          _model.textController19?.text = FFLocalizations.of(context).getText(
            'x47ffutv' /* 158.5 */,
          );
          _model.textController20?.text = FFLocalizations.of(context).getText(
            'hre9k5cz' /* 0.058 */,
          );
          _model.textController21?.text = FFLocalizations.of(context).getText(
            'ohzqxwjf' /* 8.9 */,
          );
          _model.textController22?.text = FFLocalizations.of(context).getText(
            'yrv2uq18' /* 29.6 */,
          );
          _model.textController23?.text = FFLocalizations.of(context).getText(
            'lbuwi6l6' /* 5.96 */,
          );
          _model.textController24?.text = FFLocalizations.of(context).getText(
            'lxay8pl5' /* 76.8 */,
          );
          _model.textController25?.text = FFLocalizations.of(context).getText(
            '046gua8p' /* 0.044 */,
          );
          _model.textController26?.text = FFLocalizations.of(context).getText(
            'eez3w3vh' /* 6.3 */,
          );
          _model.textController27?.text = FFLocalizations.of(context).getText(
            'mtpmabxg' /* 30 */,
          );
          _model.textController28?.text = FFLocalizations.of(context).getText(
            'km1balkl' /* 5.37 */,
          );
          _model.textController29?.text = FFLocalizations.of(context).getText(
            '47qrwmim' /* 0 */,
          );
          _model.textController30?.text = FFLocalizations.of(context).getText(
            'uvdpa8cx' /* 0.102 */,
          );
        }));
  }
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.asset(
                                'assets/images/IMG_chn0_TIMER_MNG_20240329164316_002.jpg',
                                width: MediaQuery.sizeOf(context).width * 0.33,
                                height: 240.0,
                                fit: BoxFit.cover,
                              ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/IMG_chn0_TIMER_MNG_20240329164527_003.jpg',
                                width: MediaQuery.sizeOf(context).width * 0.33,
                                height: 240.0,
                                fit: BoxFit.cover,
                              ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/IMG_chn0_TIMER_MNG_20240329163855_019.jpg',
                                width: MediaQuery.sizeOf(context).width * 0.33,
                                height: 240.0,
                                fit: BoxFit.cover,
                              ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/IMG_chn0_TIMER_MNG_20240329162143_011.jpg',
                                width: MediaQuery.sizeOf(context).width * 0.33,
                                height: 240.0,
                                fit: BoxFit.cover,
                              ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/IMG_chn0_TIMER_MNG_20240329161321_007.jpg',
                                width: MediaQuery.sizeOf(context).width * 0.33,
                                height: 240.0,
                                fit: BoxFit.cover,
                              ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/IMG_chn0_TIMER_MNG_20240329160059_001.jpg',
                                width: MediaQuery.sizeOf(context).width * 0.33,
                                height: 240.0,
                                fit: BoxFit.cover,
                              ),
